            ...
            <div class="container-fluid color-navbar pt-5">
                <div class="row mb-5" id="titulo">
                    <div class="col-8 offset-2">
                        <h1 class="mx-5 text-light fs-2 ">Encuentra tu próxima estancia</h1>
                        <p class="mx-5 text-light pb-5">Busca ofertas en hoteles, casas y mucho más...</p>
                    </div>
                </div>
            </div>
            <div class="container mx-auto">
                <form action="../alojamientos/index.html">
                    <div class="row" id="busqueda">
                        <div class="col-lg-3 col-md-2 col-sm-2 col-2 offset-1 pt-2 bg-light border border-3 border-warning rounded">
                        ...
                        <div class="col-lg-3 col-md-2 col-sm-2 col-2 pt-2 bg-light border border-3 border-warning rounded"
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <input type="number" id="habitaciones" min="0" placeholder="Habitaciones">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 pt-1">
                            <input type="submit" type="submit" class="btn btn-primary border border-3 border-warning text-truncate"
                        ...
                        <div class="row mt-3">
                            <div class="col-2 offset-1">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label"> Viajo por trabajo </label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox">
                                    <label class="form-check-label"> Busco vuelos </label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Busca alojamientos que ofrezcan estancias largas, hay muchas
                                        con tarifa mensual reducida
                                        </p>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Ínspirate, compara y reserva vuelos con más flexibilidad</p>
