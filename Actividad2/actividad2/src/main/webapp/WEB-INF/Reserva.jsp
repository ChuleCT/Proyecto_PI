        ...
        <div class="container mb-5">
            ...
            <div class="row mt-4">
                <div class="col-8 offset-2">
                    <h4 class="fw-bold">Madrid</h4>
                    <p>30 nov 2023 - 1 dic 2023</p>
                    <fieldset class="shadow rounded">
                        <div class="row py-3 ps-2">
                            ...
                            <div class="col">
                                ...
                                <p>30 nov 2023 - 1 dic 2023 - Madrid</p>
                                <p>Cancelada</p>
                            </div>
                            <div class="col text-end pe-5">
                                <p class="fw-bold fs-5 precio">Precio: 100€</p>
                                <div class="ajustes">
            ...
            <div class="row mt-4">
                <div class="col-8 offset-2">
                    <h4 class="fw-bold">Sevilla</h4>
                    <p>11 mar 2016 - 13 mar 2016</p>
                    <fieldset class="shadow rounded">
                        <div class="row py-3 ps-2">
                            <div class="col-2 ps-4">
                            ...
                            <div class="col">
                                ...
                                <p>11 mar 2016 - 13 mar 2016 - Sevilla</p>
                                <p>Completada</p>
                            </div>
                            <div class="col text-end pe-5">
                                <p class="fw-bold fs-5 precio">Precio: 100€</p>
            ...
            <div class="row mt-4">
                <div class="col-8 offset-2">
                    <h4 class="fw-bold">Nueva York</h4>
                    <p>2 ago 2011 - 8 ago 2011</p>
                    <fieldset class="shadow rounded">
                        <div class="row py-3 ps-2">
                            <div class="col-2 ps-4">
                            ...
                            <div class="col">
                                ...
                                <p>2 ago 2011 - 8 ago 2011 - Nueva York</p>
                                <p>Completada</p>
                            </div>
                            <div class="col text-end pe-5">
                                <p class="fw-bold fs-5 precio">Precio: 100€</p>
