                    ...
                    <div class="col-5 mx-auto">
                        ...
                        <form action="RegistroServlet.do" method="post">
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" placeholder="Indica tu número de teléfono" required>
                                <input type="submit" class="form-control btn btn-primary col-12" value="Crear Cuenta">
                            </div>
                        </form>
                    </div>
                </div>
