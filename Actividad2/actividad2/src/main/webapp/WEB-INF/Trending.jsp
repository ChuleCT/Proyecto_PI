        ...
        <div class="container mb-5">
            <div class="row">
                <div class="col-10 offset-1">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <img class="rounded img-fluid" src="../img/madrid.jpg" alt="foto Madrid">
                            <div class="ciudad text-center ms-2 mt-1">
                                <p class="fw-bold fs-5 text-light">Madrid</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <img class="rounded img-fluid" src="../img/sevilla.jpg" alt="foto Sevilla">
                            <div class="ciudad text-center ms-2 mt-1">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <img class="rounded img-fluid" src="../img/barcelona.jpg" alt="foto Barcelona">
                            <div class="ciudad text-center ms-2 mt-1">
                                <p class="fw-bold fs-5 text-light">Barcelona</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <img class="rounded img-fluid" src="../img/valencia.jpg" alt="foto Valencia">
                            <div class="ciudad text-center ms-2 mt-1">
                                <p class="fw-bold fs-5 text-light">Valencia</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <img class="rounded img-fluid" src="../img/granada.jpg" alt="foto Granada">
                            <div class="ciudad text-center ms-2 mt-1">
            ...
            <div class="row">
                <div class="col-10 offset-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <img class="rounded img-fluid" src="../img/cordoba.jpg" alt="foto Córdoba">
                            <p class="fw-bold mt-2">Cordoba</p>
                            <p>1,200 propiedades</p>
                        </div>
                        <div class="col">
                            <img class="rounded img-fluid" src="../img/malaga.jpg" alt="foto Málaga">
            ...
            <div class="row mt-2">
                <div class="col-10 offset-1">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <img class="rounded img-fluid" src="../img/hotel.jpeg" alt="foto ejemplo hotel">
                            <p class="fw-bold mt-2">Hoteles</p>
                            <p>6 Mar-15 Mar, 2 adultos</p>
                            <p>301 disponibles</p>
                        </div>
                        <div class="col">
                            <img class="rounded img-fluid" src="../img/apartamento.jpg" alt="foto ejemplo apartamento">
                            <p class="fw-bold mt-2">Apartamentos</p>
                            <p>6 Mar-15 Mar, 2 adultos</p>
                            <p>445 disponibles</p>
                        </div>
                        <div class="col">
                            <img class="rounded img-fluid" src="../img/villa.jpg" alt="foto ejemplo villa">
                            <p class="fw-bold mt-2">Villas</p>
                            <p>6 Mar-15 Mar, 2 adultos</p>
                            <p>2 disponibles</p>
                        </div>
                        <div class="col">
                            <img class="rounded img-fluid" src="../img/holidays.jpg" alt="foto ejemplo casa de vacaciones">
